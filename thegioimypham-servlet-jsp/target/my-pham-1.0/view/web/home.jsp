...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
        ...
        <a href="<c:url value="/single-product?action=22again"/>">
            <img class="d-block w-100" src="<c:url value="/template/images/22again.jpg"/>" alt="First slide">
        </a>
        </div>
        <div class="carousel-item">
            <img class="d-block w-100" src="<c:url value="/template/images/fedora.png"/>" alt="Second slide">
        </div>
        <div class="carousel-item">
            <img class="d-block w-100" src="<c:url value="/template/images/hoangxuan.png"/>" alt="Third slide">
        </div>
    </div>
    ...
    <div class="container">
        <div class="row justify-content-center mb-3 pb-3">
            <div class="col-md-12 heading-section text-center ftco-animate">
                <h1 class="big">Xu hướng</h1>
                <h2 class="mb-4">Các sản phẩm được yêu thích</h2>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="product-slider owl-carousel ftco-animate">
                    <div class="item">
                        <div class="product">
                            <a href="<c:url value="/single-product?action=22again"/>" class="img-prod"><img class="img-fluid"
                                                              src="<c:url value='/template/images/22againproduct.jpg'/>"
                                                              alt="Colorlib Template"> <span class="status">50%</span>
                            </a>
                            <div class="text pt-3 px-3">
                                <h3>
                                    <a href="<c:url value="/single-product?action=22again"/>">Kem dưỡng da 22AGAIN</a>
                                </h3>
                                <div class="d-flex">
                                    <div class="pricing">
                                        <p class="price">
                                            <span class="mr-2 price-dc">1.580.000 đ</span><span
                                                class="price-sale">790.000 đ</span>
                                        </p>
                                    </div>
                                    <div class="rating">
                                        <p class="text-right">
    ...
    <div class="container">
        <div class="row">
            <div
                    ...
                    style="background-image: url(<c:url value='/template/images/bg_2.jpg'/>);">
            ...
            <div class="col-md-7 py-5 wrap-about pb-md-5 ftco-animate">
                <div class="heading-section-bold mb-5 mt-md-5">
                    <div class="ml-md-0">
                        <h2 class="mb-4">
                            Online <br> <span>Beauty Shop</span>
                        </h2>
                    </div>
                </div>
                <div class="pb-md-5">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm col-md-6 col-lg ftco-animate">
                <div class="product">
                    <a href="#" class="img-prod"><img class="img-fluid"
                                                      src="<c:url value='/template/images/product-1.jpg'/>"
                                                      alt="Colorlib Template"></a>
            ...
            <div class="col-sm col-md-6 col-lg ftco-animate">
                <div class="product">
                    <a href="#" class="img-prod"><img class="img-fluid"
                                                      src="<c:url value='/template/images/product-2.jpg'/>"
                                                      alt="Colorlib Template"></a>
                    <div class="text py-3 px-3">
                        <h3>
                            <a href="#">Young Woman Wearing Dress</a>
            ...
            <div class="col-sm col-md-6 col-lg ftco-animate">
                <div class="product">
                    <a href="#" class="img-prod"><img class="img-fluid"
                                                      src="<c:url value='/template/images/product-3.jpg'/>"
                                                      alt="Colorlib Template"></a>
                    <div class="text py-3 px-3">
                        <h3>
                            <a href="#">Young Woman Wearing Dress</a>
            ...
            <div class="col-sm col-md-6 col-lg ftco-animate">
                <div class="product">
                    <a href="#" class="img-prod"><img class="img-fluid"
                                                      src="<c:url value='/template/images/product-4.jpg'/>"
                                                      alt="Colorlib Template"></a>
                    <div class="text py-3 px-3">
                        <h3>
                            <a href="#">Young Woman Wearing Dress</a>
...
<section class="ftco-section ftco-section-more img"
         style="background-image: url(<c:url value='/template/images/bg_5.jpg'/>)">
    <div class="container">
        <div class="row justify-content-center mb-3 pb-3">
                    ...
                    <div class="col-md-12">
                        <div class="carousel-testimony owl-carousel ftco-owl">
                            <div class="item">
                                <div class="testimony-wrap py-4 pb-5">
                                    <div class="user-img mb-4"
                                         style="background-image: url(<c:url value='/template/images/person_1.jpg'/>);">
											<span
                            ...
                            <div class="item">
                                <div class="testimony-wrap py-4 pb-5">
                                    <div class="user-img mb-4"
                                         style="background-image: url(<c:url value='/template/images/person_2.jpg'/>);">
											<span
                                                    class="quote d-flex align-items-center justify-content-center">
												<i class="icon-quote-left"></i>
											</span>
                            ...
                            <div class="item">
                                <div class="testimony-wrap py-4 pb-5">
                                    <div class="user-img mb-4"
                                         style="background-image: url(<c:url value='/template/images/person_3.jpg'/>);">
											<span
                                                    class="quote d-flex align-items-center justify-content-center">
												<i class="icon-quote-left"></i>
											</span>
    ...
    <div class="container">
        ...
        <div class="row d-flex">
            <div class="col-md-4 d-flex ftco-animate">
                <div class="blog-entry align-self-stretch">
                    <a href="blog-single.html" class="block-20"
                       style="background-image: url('<c:url value='/template/images/image_1.jpg'/>');">
                    </a>
            ...
            <div class="col-md-4 d-flex ftco-animate">
                <div class="blog-entry align-self-stretch">
                    <a href="blog-single.html" class="block-20"
                       style="background-image: url('<c:url value='/template/images/image_2.jpg'/>');">
                    </a>
                    <div class="text mt-3">
                        <h3 class="heading mt-3">
                            <a href="#">Even the all-powerful Pointing has no control
            ...
            <div class="col-md-4 d-flex ftco-animate">
                <div class="blog-entry align-self-stretch">
                    <a href="blog-single.html" class="block-20"
                       style="background-image: url('<c:url value='/template/images/image_3.jpg'/>');">
                    </a>
                    <div class="text mt-3">
                        <h3 class="heading mt-3">
                            <a href="#">Even the all-powerful Pointing has no control
...
<section class="ftco-section ftco-counter img" id="section-counter"
         style="background-image: url(<c:url value='/template/images/bg_4.jpg'/>);">
    <div class="container">
...
<section class="ftco-section bg-light ftco-services">
    <div class="container">
        ...
        <div class="row">
            <div
                    class="col-md-4 text-center d-flex align-self-stretch ftco-animate">
